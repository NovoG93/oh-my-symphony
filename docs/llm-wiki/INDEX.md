...
| byte-exact-static-deliverables | printf-over-echo deterministic write + cmp/od/wc/sha256sum proof chain + workspace-fixture pattern when /tmp writes are blocked | 2026-08-17 (TASK-9) |
