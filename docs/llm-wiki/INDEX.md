...
| worktree-git-sandbox | Linked-worktree git dir vs common dir split + the writable roots every backend must grant + host-owned Final History Gate + Blocked-history recovery + dirty_overlap resolution | 2026-08-17 (FIX-TASK-10-1) |
